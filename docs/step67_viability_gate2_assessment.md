...
4. Additional v2 strengthening pass:
   ...
   - anti-degeneracy support guard removed all-zero support collapse.
5. v2 interpretation:
   - regime/transition gains are now consistently strong,
   - support recovery improved in easy/hard and is near-neutral in medium in the multiseed v2 run,
   - contingency framing remains valid (no universal guarantee yet).
